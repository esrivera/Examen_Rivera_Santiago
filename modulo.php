...
<div class="page-wrapper">
                            ...
                            <div class="form">
                                <form action="buscar" method="POST">
                                    <div class="col-auto my-1">
                                        <h3 class="mr-sm-2" for="inlineFormCustomSelect">Rol:</h3>
    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
        <div class="card">
            <div class="card-body">
                <form name="forma" class="form-horizontal form-material" method="post" action="modulo.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-12">
                            <input type="text" placeholder="54074" class="form-control
                                            form-control-line col-sm-6" name="codigo" id="codigo" required>
                            <div class="input-group-prepend
                                            cold-md-4">
                                <span class="input-group-text"></span>
                            </div>
                            <select name="estado" class="custom-select mr-sm-4" id="estado">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input class="btn btn-success btn-block" type="submit" name="accion" value="Agregar">
                        </div>
                    </div>
                </form>
            </div>
